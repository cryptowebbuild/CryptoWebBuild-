...
const Web3GamingProxy = lazy(() => import('./pages/blog/Web3GamingProxy'));
    ...
    <Layout>
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          {/* 11. Web3 Gaming Proxy */}
          <Route path="/blog/web3-gaming-zero-latency-proxy" element={<Web3GamingProxy />} />
