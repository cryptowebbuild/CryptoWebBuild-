...
const GigaChadMockup: React.FC<GigaChadMockupProps> = ({ className = '' }) => {
  return (
    <div className={`bg-[#05010d] relative overflow-hidden flex flex-col font-sans select-none ${className}`}>
      ...
      {/* Stars */}
      <div className="absolute top-10 left-10 w-1 h-1 bg-white dark:bg-[#020617] rounded-full opacity-70 animate-pulse"></div>
      ...
      <div className="h-8 bg-[#22c55e] flex items-center overflow-hidden relative z-10 shrink-0 transform -skew-y-2 mt-6 border-y-2 border-black shadow-[0_0_20px_rgba(34,197,94,0.3)]">
        <div className="flex gap-6 text-xs font-black uppercase text-black dark:text-gray-100 italic tracking-tighter whitespace-nowrap px-4 animate-marquee">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
        ...
        <div className="flex gap-3 mt-6 w-full max-w-[320px]">
            <div className="flex-1 py-2.5 bg-gradient-to-r from-[#22c55e] to-green-600 hover:to-green-500 text-black dark:text-gray-100 font-black text-xs uppercase tracking-wide rounded-lg transition-all transform hover:scale-105 shadow-[0_0_15px_rgba(34,197,94,0.3)] flex items-center justify-center gap-1">
