...
const KeyTakeaways: React.FC<KeyTakeawaysProps> = ({ points }) => {
  return (
    <div className="my-12 w-full max-w-full p-6 md:p-8 rounded-[32px] bg-gradient-to-br from-purple-50/50 via-white to-purple-50/50 dark:from-[#1e293b] dark:via-[#0f172a] dark:to-[#1e293b] border border-purple-100 dark:border-purple-900/30 shadow-xl shadow-purple-900/5 relative overflow-hidden group">
