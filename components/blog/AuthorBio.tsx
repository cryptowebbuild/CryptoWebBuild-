    ...
    <div className="flex flex-col md:flex-row items-center gap-8 p-8 bg-white dark:bg-[#1e293b] rounded-[32px] border border-gray-200 dark:border-white/5 shadow-xl relative overflow-hidden">
      ...
      <div className="text-center md:text-left flex-1">
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
            ...
            <a href="https://twitter.com/WebBuildDev" target="_blank" rel="noopener noreferrer" className="px-5 py-2 rounded-xl bg-blue-500 text-white font-bold text-sm hover:bg-blue-600 transition-all flex items-center gap-2">
