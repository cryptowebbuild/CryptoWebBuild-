...
const ThemeToggle = ({ isDark, toggle }: { isDark: boolean; toggle: () => void }) => (
  <button
    onClick={toggle}
    className="p-2 rounded-full text-text-muted hover:text-text-main hover:bg-surface-highlight transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500"
